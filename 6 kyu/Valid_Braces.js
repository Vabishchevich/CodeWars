...
This Kata is similar to the Valid Parentheses Kata, but introduces new characters: brackets [], and curly braces {}. Thanks to 
...
else if (stack[stack.length-1] == valid[braces[i]]) {
stack.pop();
}
else {
return false;
